...
| *Attendees (to planning meeting)* | Marco Nakasone y Jose Chirito |
...
|------------------------------------|------------------|-------------------------|--------------------------------|---------------------------|
| Nakasone Gomes, Marco Antonio      | marquinho04      | L                       | C                              | L                         |
| Chirito Torres, Jose Raul          | JoseR044         | C                       | L                              | C                         |
| Martinez Gaona, Pablo Afranio      | Delzekl          | C                       | C                              | C                         |
...
![backend](../../assets/chapter-5/backend_evidence1.png)  

![backend](../../assets/chapter-5/backend_evidence2.png)  

![backend](../../assets/chapter-5/backend_evidence3.png)  
