...
| EP07  | Administracion de PLataforma | Como organizador  quiero supervisar la calidad del sistema. | N/A | - |
...
| US19  |Tener un panel de información |Como administrador quiero un panel para ver las estadísticas de mis eventos. |**Dado que** el administrador, **cuando** selecciona el apartado de panel, **entonces** se muestra estadísticas de los eventos.| EP7 |
| US20  | Gestión de eventos publicados | Como organizador quiero tener un apartado donde pueda ver los eventos que he publicado y poder editarlos fácilmente, para mantener la información siempre actualizada. | **Dado que** el organizador ha iniciado sesión y accede al apartado de eventos publicados, **cuando** selecciona un evento específico, **entonces** puede visualizar su información y realizar cambios en los datos del evento. | EP07 |
| US21  | Creación de eventos con detalles completos | Como organizador quiero poder agregar imágenes, dirección y rango de fechas al crear un evento, para mostrar información clara y atractiva a los visitantes. | **Dado que** el organizador está creando un nuevo evento, **cuando** completa los campos de imágenes, dirección y rango de fechas, **entonces** el sistema guarda toda la información y la muestra correctamente en la vista del evento. | EP07 |
